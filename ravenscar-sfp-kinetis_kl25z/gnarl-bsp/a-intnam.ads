...
package Ada.Interrupts.Names is
   ...
   DMA0_Interrupt                   : constant Interrupt_ID :=
     Kinetis_KL25Z.External_Interrupt_Type'Pos (Kinetis_KL25Z.DMA0_IRQ) + 2;

   UART0_Interrupt                   : constant Interrupt_ID :=
     Kinetis_KL25Z.External_Interrupt_Type'Pos (Kinetis_KL25Z.UART0_IRQ) + 2;

   UART1_Interrupt                   : constant Interrupt_ID :=
     Kinetis_KL25Z.External_Interrupt_Type'Pos (Kinetis_KL25Z.UART1_IRQ) + 2;
